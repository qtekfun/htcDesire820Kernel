...
int MatrixLogarithmAtomic<MatrixType>::getPadeDegree(long double normTminusI)
{
  ...
  const double maxNormForPade[] = { 5.48256690357782863103e-3 , 2.34559162387971167321e-2,
            5.84603923897347449857e-2, 1.08486423756725170223e-1, 1.68385767881294446649e-1,
            2.32777776523703892094e-1 };
#elif LDBL_MANT_DIG <= 106        
  const double maxNormForPade[] = { 8.58970550342939562202529664318890e-5 ,
...
#else                             
  const double maxNormForPade[] = { 4.7419931187193005048501568167858103e-5 ,
