...
#define INITIAL_DTLS_TIMEOUT_MS   1000  
#define MAX_DTLS_TIMEOUT_MS      60000  
#define DTLS_FINISHED_TIMER_MS  120000  
...
#define ssl_SEND_FLAG_USE_EPOCH		0x10000000 
...
#define TLS_EX_SESS_TICKET_LIFETIME_HINT    (2 * 24 * 60 * 60) 
