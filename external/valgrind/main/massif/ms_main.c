...
{
   static Addr hp     = 0;    
   static Addr hp_lim = 0;    

   #define SUPERBLOCK_SIZE  (1 << 20)         
                            ...
                            SizeT snapshot_heap_szB, SizeT snapshot_total_szB)
{
   ...
   switch (sxpt->tag) {
    case SigSXPt:
      ...
      FP_buf[BUF_LEN-18+j-5] = '.';    
      FP_buf[BUF_LEN-18+j-4] = '.';    
      FP_buf[BUF_LEN-18+j-3] = '.';
      FP_buf[BUF_LEN-18+j-2] = '\n';   
      FP_buf[BUF_LEN-18+j-1] = '\0';   
      VG_(write)(fd, (void*)FP_buf, VG_(strlen)(FP_buf));
