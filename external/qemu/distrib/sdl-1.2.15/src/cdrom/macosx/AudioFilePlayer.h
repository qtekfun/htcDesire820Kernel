...
typedef struct S_AudioFilePlayer
{
    ...
    void            (*SetStartFrame)(struct S_AudioFilePlayer *afp, int frame); 
    int             (*GetCurrentFrame)(struct S_AudioFilePlayer *afp); 
    void            (*SetStopFrame)(struct S_AudioFilePlayer *afp, int frame);   
...
typedef struct S_AudioFileManager
{
    ...
    void                (*SetPosition)(struct S_AudioFileManager *afm, SInt64 pos);  
    int                 (*GetByteCounter)(struct S_AudioFileManager *afm);  
    void                (*SetEndOfFile)(struct S_AudioFileManager *afm, SInt64 pos);  
