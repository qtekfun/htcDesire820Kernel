...
static permute_test_t permute_tests[] =
{
  ...
  { &test_xxmrghw, "xxmrghw", 
    ...
    { 0x11111111, 0x22222222, 0x33333333, 0x44444444 }, 
    { 0x00112233, 0x11111111, 0x44556677, 0x22222222 }  
  },
  { &test_xxmrglw, "xxmrglw", 
    { 0x11111111, 0x22222222, 0x33333333, 0x44444444 }, 
    { 0x55555555, 0x66666666, 0x77777777, 0x88888888 }, 
    { 0x33333333, 0x77777777, 0x44444444, 0x88888888 }  
  },
  { &test_xxmrglw, "xxmrglw", 
    { 0x00112233, 0x44556677, 0x8899aabb, 0xccddeeff}, 
    { 0x11111111, 0x22222222, 0x33333333, 0x44444444}, 
    { 0x8899aabb, 0x33333333, 0xccddeeff, 0x44444444}  
  },
  { &test_xxpermdi_00, "xxpermdi DM=00", 
    { 0x11111111, 0x22222222, 0x33333333, 0x44444444 }, 
    { 0x55555555, 0x66666666, 0x77777777, 0x88888888 }, 
    { 0x11111111, 0x22222222, 0x55555555, 0x66666666 }  
  },
  { &test_xxpermdi_01, "xxpermdi DM=01", 
    { 0x11111111, 0x22222222, 0x33333333, 0x44444444 }, 
    { 0x55555555, 0x66666666, 0x77777777, 0x88888888 }, 
    { 0x11111111, 0x22222222, 0x77777777, 0x88888888 }  
  },
  ...
  { &test_xxpermdi_11, "xxpermdi DM=11", 
    { 0x11111111, 0x22222222, 0x33333333, 0x44444444 }, 
    { 0x55555555, 0x66666666, 0x77777777, 0x88888888 }, 
    { 0x33333333, 0x44444444, 0x77777777, 0x88888888 }  
  },
         ...
         switch (test_type) {
            ...
            case VX_FP_OTHER:
            {
               ...
               if (test_type != VX_FP_OTHER) {
                  ...
                  if (repeat) {
                     memcpy(&vec_out, inB, 8);  
                     memcpy(&vec_inB, &spec_fargs[extra_arg_idx], 8);  
                     frbp = (unsigned long long *)&spec_fargs[extra_arg_idx];
                  } else {
                     
                     memcpy(&vec_out, &spec_fargs[extra_arg_idx], 8);  
                  }
