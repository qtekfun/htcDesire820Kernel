...
int  trio_get_spacing TRIO_PROTO((trio_pointer_t ref)); 
...
#if TRIO_C99
int  trio_get_largest TRIO_PROTO((trio_pointer_t ref)); 
void trio_set_largest TRIO_PROTO((trio_pointer_t ref, int is_largest));
int  trio_get_ptrdiff TRIO_PROTO((trio_pointer_t ref)); 
void trio_set_ptrdiff TRIO_PROTO((trio_pointer_t ref, int is_ptrdiff));
int  trio_get_size TRIO_PROTO((trio_pointer_t ref)); 
