...
#define FIOQSIZE_PORTABLE       0x545E 
...
#ifdef USE_OLD_TTY
# define TIOCGETD_PORTABLE   _IOR_PORTABLE('t', 0, int)       
# define TIOCSETD_PORTABLE   _IOW_PORTABLE('t', 1, int)       
#else
# define OTIOCGETD_PORTABLE  _IOR_PORTABLE('t', 0, int)       
# define OTIOCSETD_PORTABLE  _IOW_PORTABLE('t', 1, int)       
#endif
