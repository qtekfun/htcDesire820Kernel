...
PgColor_t ph_ExpandColor(_THIS, SDL_Surface* surface, Uint32 color)
{
    ...
    switch(surface->format->BitsPerPixel)
    {
       ...
       case 15: 
            {
                truecolor = ((color & 0x00007C00UL) << 9) |   
                            ((color & 0x000003E0UL) << 6) |   
                            ((color & 0x0000001FUL) << 3) |   
                            ((color & 0x00007000UL) << 4) |   
                            ((color & 0x00000380UL) << 1) |   
                            ((color & 0x0000001CUL) >> 2);    
            }
            break;
       case 16: 
            {
                truecolor = ((color & 0x0000F800UL) << 8) |   
                            ((color & 0x000007E0UL) << 5) |   
                            ((color & 0x0000001FUL) << 3) |   
                            ((color & 0x0000E000UL) << 3) |   
                            ((color & 0x00000600UL) >> 1) |   
                            ((color & 0x0000001CUL) >> 2);    
