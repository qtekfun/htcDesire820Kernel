    ...
    *pcur      = cur;
    ...
    switch (dataCoding >> 4) {
        ...
        case 0x04: case 0x05: case 0x06: case 0x07:
            if (dataCoding & 0x20)           return SMS_CODING_SCHEME_UNKNOWN; 
...
gsm_rope_add_sms_user_header( GsmRope  rope,
                              ...
                              int      pdu_index )
{
    gsm_rope_add_c( rope, 0x05 );     
    gsm_rope_add_c( rope, 0x00 );     
    gsm_rope_add_c( rope, 0x03 );     
    gsm_rope_add_c( rope, (byte_t)ref_number );  
    gsm_rope_add_c( rope, (byte_t)pdu_count );     
    gsm_rope_add_c( rope, (byte_t)pdu_index+1 );   
}
                              ...
                              int                     pdu_index)
{
    ...
    gsm_rope_add_c( rope, 0 );        
    gsm_rope_add_c( rope, mtiByte );     
    ...
    gsm_rope_add_c( rope, coding );               
    gsm_rope_add_timestamp( rope, timestamp );    
