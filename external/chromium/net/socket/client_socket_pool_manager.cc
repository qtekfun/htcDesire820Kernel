...
// Added by Daniel.cw_Tsai >>
// The original value is 6. In order to speed up the download speed, we tuned this value to 10.
// This will cause the CloudFour Concurrency test fail (ITS K2_CL_ICS_40#321). Therefore, we
// set this value to 6 for Sprint, Boost and VMUS projects. And keep the value 10 for other
// projects.
#if defined CFLAG_PROJECT_Sprint || defined CFLAG_PROJECT_Boost || defined CFLAG_PROJECT_VMUS
int g_max_sockets_per_group = 6;    // Original setting.
#else
//increase max-connection per server ( 6 -> 18 )
