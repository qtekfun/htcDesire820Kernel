...
s390_insn_get_reg_usage(HRegUsage *u, const s390_insn *insn)
{
   ...
   case S390_INSN_BFP_BINOP:
      ...
      addHRegUse(u, HRmRead,  insn->variant.bfp_binop.dst);  
      addHRegUse(u, HRmRead,  insn->variant.bfp_binop.op2);  
      break;

   case S390_INSN_BFP_UNOP:
      addHRegUse(u, HRmWrite, insn->variant.bfp_unop.dst);
      addHRegUse(u, HRmRead,  insn->variant.bfp_unop.op);  
      break;

   case S390_INSN_BFP_COMPARE:
      addHRegUse(u, HRmWrite, insn->variant.bfp_compare.dst);
      addHRegUse(u, HRmRead,  insn->variant.bfp_compare.op1);  
      addHRegUse(u, HRmRead,  insn->variant.bfp_compare.op2);  
      break;
   ...
   case S390_INSN_BFP128_BINOP:
      ...
      addHRegUse(u, HRmRead,  insn->variant.bfp128_binop.dst_hi);  
      addHRegUse(u, HRmRead,  insn->variant.bfp128_binop.dst_lo);  
      addHRegUse(u, HRmRead,  insn->variant.bfp128_binop.op2_hi);  
      addHRegUse(u, HRmRead,  insn->variant.bfp128_binop.op2_lo);  
      break;

   case S390_INSN_BFP128_COMPARE:
      addHRegUse(u, HRmWrite, insn->variant.bfp128_compare.dst);
      addHRegUse(u, HRmRead,  insn->variant.bfp128_compare.op1_hi);  
      addHRegUse(u, HRmRead,  insn->variant.bfp128_compare.op1_lo);  
      addHRegUse(u, HRmRead,  insn->variant.bfp128_compare.op2_hi);  
      addHRegUse(u, HRmRead,  insn->variant.bfp128_compare.op2_lo);  
      break;
                            ...
                            HReg dst_lo, HReg op)
{
   ...
   insn->variant.bfp128_unop.op_lo = INVALID_HREG;  
   insn->variant.bfp128_unop.rounding_mode = S390_ROUND_NEAREST_EVEN; 
                              ...
                              s390_round_t rounding_mode)
{
   ...
   insn->variant.bfp128_unop.dst_lo = INVALID_HREG;  
   insn->variant.bfp128_unop.op_hi = op_hi;
   insn->variant.bfp128_unop.op_lo = op_lo;
   insn->variant.bfp128_unop.rounding_mode = rounding_mode;
...
s390_insn_cdas_emit(UChar *buf, const s390_insn *insn)
{
   ...
   r1   = hregNumber(insn->variant.cdas.op1_high); 
   r1p1 = hregNumber(insn->variant.cdas.op1_low);  
...
s390_insn_helper_call_emit(UChar *buf, const s390_insn *insn)
{
   ...
   buf = s390_emit_STG(buf, S390_REGNO_LINK_REGISTER, 0,        
   ...
   buf = s390_emit_LG(buf, S390_REGNO_LINK_REGISTER, 0,         
                      S390_REGNO_STACK_POINTER, S390_OFFSET_SAVED_LR, 0);
...
s390_set_fpc_rounding_mode(UChar *buf, s390_round_t rounding_mode)
{
   ...
   buf = s390_emit_NILL(buf, R0, 0xFFFC); 
   buf = s390_emit_OILL(buf, R0, bits);   
   buf = s390_emit_SFPC(buf, R0, 0);      
