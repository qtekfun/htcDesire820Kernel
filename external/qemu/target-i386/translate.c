...
static inline void gen_setcc_slow_T0(DisasContext *s, int jcc_op)
{
    ...
    case JCC_L:
        gen_compute_eflags(cpu_tmp0);
        tcg_gen_shri_tl(cpu_T[0], cpu_tmp0, 11); 
        tcg_gen_shri_tl(cpu_tmp0, cpu_tmp0, 7); 
    ...
    case JCC_LE:
        gen_compute_eflags(cpu_tmp0);
        tcg_gen_shri_tl(cpu_T[0], cpu_tmp0, 11); 
        tcg_gen_shri_tl(cpu_tmp4, cpu_tmp0, 7); 
        tcg_gen_shri_tl(cpu_tmp0, cpu_tmp0, 6); 
...
static void *sse_op_table1[256][4] = {
    ...
    [0x54] = { gen_helper_pand_xmm, gen_helper_pand_xmm }, 
    [0x55] = { gen_helper_pandn_xmm, gen_helper_pandn_xmm }, 
    [0x56] = { gen_helper_por_xmm, gen_helper_por_xmm }, 
    [0x57] = { gen_helper_pxor_xmm, gen_helper_pxor_xmm }, 
    [0x58] = SSE_FOP(add),
    [0x59] = SSE_FOP(mul),
    ...
    [0xc4] = { SSE_SPECIAL, SSE_SPECIAL }, 
    [0xc5] = { SSE_SPECIAL, SSE_SPECIAL }, 
...
static void *sse_op_table5[256] = {
    ...
    [0xa6] = gen_helper_movq, 
    [0xa7] = gen_helper_movq, 
    [0xaa] = gen_helper_pfsubr,
    [0xae] = gen_helper_pfacc,
    [0xb0] = gen_helper_pfcmpeq,
    [0xb4] = gen_helper_pfmul,
    [0xb6] = gen_helper_movq, 
