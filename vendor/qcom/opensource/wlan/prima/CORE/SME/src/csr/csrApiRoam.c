                ...
                while(pCommand->u.roamCmd.pRoamBssEntry)
                {
                    ...
                    if (!concurrentChannel)
                    {
                            ...
                            pCommand->u.roamCmd.roamId)))
                        {
                            ...
                            smsLog(pMac, LOGE, FL("  MCC MLHD : roam due to same channel or MCC supported"));
                            break;
                        }
                     }
                     else
                     {
                         smsLog(pMac, LOGE, FL("  MCC MLHD : do not roam since not same channel under concurrent"));
