...
mmx_interp255( mmx_t  m1, mmx_t  m2, mmx_t  zero, int  alpha )
{
    ...
    mult  = _mm_cvtsi32_si64( alpha );                   
    mult2 = _mm_slli_si64( mult, 32 );                   
    mult  = _mm_or_si64( mult, mult2 );                  

    t1 = _mm_unpackhi_pi16( m1, m2 );    
    r1 = _mm_madd_pi16( t1, mult );      

    t2 = _mm_unpacklo_pi16( m1, m2 );    
    r2 = _mm_madd_pi16( t2, mult );      
