...
static PyTypeObject __pyx_type_8bintrees_7cwalker_cWalker = {
  ...
  __Pyx_NAMESTR("bintrees.cwalker.cWalker"), 
  sizeof(struct __pyx_obj_8bintrees_7cwalker_cWalker), 
  0, 
  __pyx_tp_dealloc_8bintrees_7cwalker_cWalker, 
  0, 
  0, 
  0, 
  #if PY_MAJOR_VERSION < 3
  ...
  #endif
  0, 
  &__pyx_tp_as_number_cWalker, 
  &__pyx_tp_as_sequence_cWalker, 
  &__pyx_tp_as_mapping_cWalker, 
  0, 
  0, 
  0, 
  0, 
  0, 
  &__pyx_tp_as_buffer_cWalker, 
  ...
  0, 
  0, 
  __pyx_methods_8bintrees_7cwalker_cWalker, 
  0, 
  0, 
  0, 
  0, 
  ...
  0, 
  0, 
  __pyx_tp_new_8bintrees_7cwalker_cWalker, 
  0, 
  0, 
  0, 
  0, 
