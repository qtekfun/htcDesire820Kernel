...
} sDefaultResponses[] =
{
    ...
    { "+CTEC=?", "+CTEC: 0,1,2,3", NULL }, 
    { "!+CTEC", NULL, handleTech }, 

    { "+WRMP=?", "+WRMP: 0,1,2", NULL }, 
    { "!+WRMP", NULL, handleRoamPref }, 

    { "+CCSS=?", "+CTEC: 0,1", NULL }, 
    { "!+CCSS", NULL, handleSubscriptionSource }, 

    { "+WSOS=?", "+WSOS: 0", NULL}, 
    { "!+WSOS=", NULL, handleEmergencyMode },

    { "+WPRL?", NULL, handlePrlVersion }, 
    ...
    { "+CIMI", OPERATOR_HOME_MCCMNC "000000000", NULL },   
    { "+CGSN", "000000000000000", NULL },   
    { "+CUSD=2",NULL, NULL }, 
    { "+COPS=0", NULL, handleOperatorSelection }, 
    { "!+CMGD=", NULL, handleDeleteSMSonSIM }, 
