...
#define F_SETLEASE_PORTABLE             (F_LINUX_SPECIFIC_BASE+0)       
#define F_GETLEASE_PORTABLE             (F_LINUX_SPECIFIC_BASE+1)       
#define F_NOTIFY_PORTABLE               (F_LINUX_SPECIFIC_BASE+2)       

#define F_CANCELLK_PORTABLE             (F_LINUX_SPECIFIC_BASE+5)       
#define F_DUPFD_CLOEXEC_PORTABLE        (F_LINUX_SPECIFIC_BASE+6)       
