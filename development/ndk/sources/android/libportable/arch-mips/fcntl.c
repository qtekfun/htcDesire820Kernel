...
static char *map_portable_cmd_to_name(int cmd)
{
    ...
    switch(cmd) {
    case F_DUPFD_PORTABLE:              name = "F_DUPFD_PORTABLE";              break;  
    case F_GETFD_PORTABLE:              name = "F_GETFD_PORTABLE";              break;  
    case F_SETFD_PORTABLE:              name = "F_SETFD_PORTABLE";              break;  
    case F_GETFL_PORTABLE:              name = "F_GETFL_PORTABLE";              break;  
    case F_SETFL_PORTABLE:              name = "F_SETFL_PORTABLE";              break;  
    case F_GETLK_PORTABLE:              name = "F_GETLK_PORTABLE";              break;  
    case F_SETLK_PORTABLE:              name = "F_SETLK_PORTABLE";              break;  
    case F_SETLKW_PORTABLE:             name = "F_SETLKW_PORTABLE";             break;  
    case F_SETOWN_PORTABLE:             name = "F_SETOWN_PORTABLE";             break;  
    case F_GETOWN_PORTABLE:             name = "F_GETOWN_PORTABLE";             break;  
    case F_SETSIG_PORTABLE:             name = "F_SETSIG_PORTABLE";             break;  
    case F_GETSIG_PORTABLE:             name = "F_GETSIG_PORTABLE";             break;  
    case F_GETLK64_PORTABLE:            name = "F_GETLK64_PORTABLE";            break;  
    case F_SETLK64_PORTABLE:            name = "F_SETLK64_PORTABLE";            break;  
    case F_SETLKW64_PORTABLE:           name = "F_SETLKW64_PORTABLE";           break;  
    case F_SETLEASE_PORTABLE:           name = "F_SETLEASE_PORTABLE";           break;  
    case F_GETLEASE_PORTABLE:           name = "F_GETLEASE_PORTABLE";           break;  
    case F_NOTIFY_PORTABLE:             name = "F_NOTIFY_PORTABLE";             break;  
    case F_CANCELLK_PORTABLE:           name = "F_CANCELLK_PORTABLE";           break;  
    case F_DUPFD_CLOEXEC_PORTABLE:      name = "F_DUPFD_CLOEXEC_PORTABLE";      break;  
...
static int fcntl_cmd_pton(int portable_cmd)
{
    ...
    switch(portable_cmd) {
    case F_DUPFD_PORTABLE:      
        native_cmd =  F_DUPFD;
        break;

    case F_GETFD_PORTABLE:      
        native_cmd = F_GETFD;
        break;

    case F_SETFD_PORTABLE:      
        native_cmd = F_SETFD;
        break;

    case F_GETFL_PORTABLE:      
        native_cmd = F_GETFL;
        break;

    case F_SETFL_PORTABLE:      
        native_cmd = F_SETFL;
        break;
    ...
    case F_SETSIG_PORTABLE:     
        native_cmd = F_SETSIG;
        break;

    case F_GETSIG_PORTABLE:     
        native_cmd = F_GETSIG;
        break;
    ...
    case F_SETLEASE_PORTABLE:   
        native_cmd =  F_SETLEASE;
        break;

    case F_GETLEASE_PORTABLE:   
        native_cmd = F_GETLEASE;
        break;

    case F_NOTIFY_PORTABLE:      
        native_cmd = F_NOTIFY;
        break;

    case F_CANCELLK_PORTABLE:      
        error_msg = "Case F_CANCELLK_PORTABLE: Not supported by MIPS. ";
        native_cmd = portable_cmd;
        break;

    case F_DUPFD_CLOEXEC_PORTABLE: 
...
int WRAP(fcntl)(int fd, int portable_cmd, ...)
{
    ...
    case F_SETLKW:
        ...
        flock.l_sysid = 0L;
        flock.l_pid = flock_portable->l_pid;    
    ...
    case F_SETLKW64:
        ...
        flock64.l_pid = flock64_portable->l_pid;        
