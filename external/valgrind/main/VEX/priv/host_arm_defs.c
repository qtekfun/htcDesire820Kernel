                    ...
                    void* disp_cp_xassisted )
{
   ...
   switch (i->tag) {
      ...
      case ARMin_XDirect: {
         ...
         p = imm32_to_iregNo(p, 12, i->ARMin.XDirect.dstGA);
         ...
         p = imm32_to_iregNo_EXACTLY2(p, 12,
      ...
      case ARMin_ProfInc: {
         p = imm32_to_iregNo_EXACTLY2(p, 12, 0x65556555);
         *p++ = 0xE59CB000;
         *p++ = 0xE29BB001;
         *p++ = 0xE58CB000;
         *p++ = 0xE59CB004;
                                 ...
                                 void* place_to_jump_to )
{
   ...
   vassert(is_imm32_to_iregNo_EXACTLY2(
              p, 12, (UInt)Ptr_to_ULong(disp_cp_chain_me_EXPECTED)));
   ...
   if (shortOK) {
      ...
      (void)imm32_to_iregNo_EXACTLY2(
               p, 12, (UInt)Ptr_to_ULong(place_to_jump_to));
      p[2] = 0xE12FFF1C;
   }
                                   ...
                                   void* disp_cp_chain_me )
{
   ...
   if (is_imm32_to_iregNo_EXACTLY2(
          p, 12, (UInt)Ptr_to_ULong(place_to_jump_to_EXPECTED))
       && p[2] == 0xE12FFF1C) {
      valid = True; 
      if (0)
   ...
   (void)imm32_to_iregNo_EXACTLY2(
            p, 12, (UInt)Ptr_to_ULong(disp_cp_chain_me));
   p[2] = 0xE12FFF3C;
   VexInvalRange vir = {(HWord)p, 12};
   return vir;
}
                                 ...
                                 ULong* location_of_counter )
{
   ...
   vassert(0 == (3 & (HWord)p));
   vassert(is_imm32_to_iregNo_EXACTLY2(p, 12, 0x65556555));
