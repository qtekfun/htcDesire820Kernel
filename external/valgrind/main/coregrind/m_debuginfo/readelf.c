...
#    undef BAD
   ...
   
   {
      ...
      UChar*     strtab_img       = NULL; 
      ElfXX_Sym* symtab_img       = NULL; 
      UChar*     dynstr_img       = NULL; 
      ElfXX_Sym* dynsym_img       = NULL; 
      UChar*     debuglink_img    = NULL; 
      UChar*     debugaltlink_img = NULL; 
      UChar*     stab_img         = NULL; 
      UChar*     stabstr_img      = NULL; 
      UChar*     debug_line_img   = NULL; 
      UChar*     debug_info_img   = NULL; 
      UChar*     debug_types_img  = NULL; 
      UChar*     debug_abbv_img   = NULL; 
      UChar*     debug_str_img    = NULL; 
      UChar*     debug_ranges_img = NULL; 
      UChar*     debug_loc_img    = NULL; 
      UChar*     debug_frame_img  = NULL; 
      UChar*     debug_line_alt_img = NULL; 
      UChar*     debug_info_alt_img = NULL; 
      UChar*     debug_abbv_alt_img = NULL; 
      UChar*     debug_str_alt_img = NULL; 
      UChar*     dwarf1d_img      = NULL; 
      UChar*     dwarf1l_img      = NULL; 
      UChar*     opd_img          = NULL; 
      UChar*     ehframe_img[N_EHFRAME_SECTS]; 
