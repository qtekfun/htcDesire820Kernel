...
#  elif defined(__powerpc__)
   ...
   gst.guest_GPR3  = (UInt)serviceFn; 
   gst.guest_GPR2  = saved_R2;
   gst.guest_LR    = 0x12345678; 
#else 
   get_R13();
   gst.guest_CIA   = * (ULong*)entryP;
   gst.guest_GPR1  = (ULong)&gstack[25000]; 
   gst.guest_GPR3  = (ULong)serviceFn;      
   gst.guest_GPR2  = saved_R2;
   gst.guest_GPR13 = saved_R13;
   gst.guest_LR    = 0x1234567812345678ULL; 
#endif
