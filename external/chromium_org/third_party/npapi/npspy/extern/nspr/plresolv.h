...
#define PL_RESOLVE_EWINIT        1           
#define PL_RESOLVE_EMAKE         2           
#define PL_RESOLVE_ELAUNCH       3           
#define PL_RESOLVE_ETIMEDOUT     4           
#define PL_RESOLVE_EINVAL        5           
#define PL_RESOLVE_EOVERFLOW     6           
#define PL_RESOLVE_EUNKNOWN      7           
