...
class GLES2DecoderTestBase : public testing::Test {
 ...
 protected:
  ...
  static const GLint kUniform1FakeLocation = 0;               
  static const GLint kUniform2FakeLocation = 1;               
  static const GLint kUniform2ElementFakeLocation = 0x10001;  
  static const GLint kUniform3FakeLocation = 2;               
 ...
 private:
  class MockCommandBufferEngine : public CommandBufferEngine {
   public:
    ...
    virtual bool SetGetBuffer(int32 ) OVERRIDE;
